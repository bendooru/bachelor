...
$f$-vector simply counts all polyhedra in the fan grouped by dimension. In that regard,
it gives an intuition for the \enquote{size} of the computational problem.
