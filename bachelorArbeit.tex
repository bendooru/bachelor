...
questions: Many theorems have counterparts in tropical geometry or even carry over
entirely by a correspondence theorem relating algebraic and tropical objects, see for
instance \cite{mikhEnum}. As usual, mathematicians are interested in studying concrete
examples of tropical varieties -- for instance to gain a general intuition behind the
combinatorial structures or to find counterexamples.
