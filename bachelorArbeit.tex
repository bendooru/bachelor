...
\begin{itemize}
  ...
  \item The net terminates if all tokens corresponding to tokens have been processed,
    which can be checked by the (implied) token counting mentioned before. Additionally,
    it is necessary that $e_1$ and $e_2$ hold \texttt{false}.
\end{itemize}
...
\begin{table}[tbh]
  \centering
  \begin{tabular}{r|l||l}
    \textbf{cores} & \textbf{time [s], one machine} & \textbf{two machines} \\ \hline
    1   & 792.806 &      -- \\
    2   & 389.855 & 375.859 \\
    4   & 190.589 & 191.739 \\
    8   &  99.254 &  96.990 \\
