...
Definition~\ref{def:petri} can be visualized as a directed bipartite graph $G = (S \cup T,
F)$.

% TODO make styles global
\begin{figure}[htbp]
  \centering
  \begin{subfigure}{.4\textwidth}
    \centering
    \begin{tikzpicture}[node distance=1.4cm]
      \tikzstyle{place}=[circle,minimum size=6mm,draw]
      \tikzstyle{transition}=[rectangle,minimum size=6mm,draw]
      % petri net
      \begin{scope}
        \node [place]      (in)                {$i$};
