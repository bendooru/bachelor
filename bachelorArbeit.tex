...
varieties is the so-called \emph{f-vector} of the polyhedral fan it corresponds to. Th
f-vector simply counts all polyhedra in the fan grouped by dimension. In that regard, it
gives an intuition for the \enquote{size} of the computational problem.
...
\begin{example} \label{ex:fVec}
  ...
  zeroes of the f-vector are omitted.
\end{example}
