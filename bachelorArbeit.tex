...
\begin{enumerate}[label=\arabic*.]
  ...
  \item On the practical side we may also start with an ideal $I \idealof \setC[\vec x]$
    ...
    In fact, the current implementation in \texttt{tropicalNewton.lib} \cite{tropNewtLib}
    is designed in this way and handles only the \emph{constant coefficient case} for
    initial ideals. All other cases may then be transformed as in the first point.
