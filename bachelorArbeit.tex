...
accessible way. During execution they are interpreted by the workflow engine.
...
\begin{description}[leftmargin=\parindent]
  \item[Time:] As any enabled transitions will fire immediately in a traditional Petri
    ...
    and 2 are immediate, a complete description the includes the knowledge about all
