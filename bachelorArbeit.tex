...
provide a basic introduction to this topic while focusing on the computational aspects. In
particular we will discuss our main interest of this thesis -- the recently developed
techniques using Newton polygons and valuations.
...
semiring} and this is sometimes also referred to a as the \emph{min-plus algebra}. By
replacing taking minima with maxima, we obtain the isomorphic max-plus algebra which is
also used as the underlying structure in tropical geometry by some authors.
