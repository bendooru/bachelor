...
In Figure~\ref{fig:full_net} we see our Petri net as it is realized in practice. Note that
the additional places and transitions described above make this rendition of the net quite
messy. It further includes a final transition that combines all found cones from their
files on disk into a single file.
